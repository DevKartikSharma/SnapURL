...
const Page = () => {
    ...
    return <>
        {(!Error ? <>
            ...
            <div className='bg-[rgba(168,168,168,0.24)] px-12 py-6 w-[50%] h-fit mt-30 flex flex-col justify-center items-center rounded-2xl text-xl font-light space-y-6 select-none '>
